    ...
    return (
      <div className="App">
        <div className="overflow-wrap">
            ...
            <div className="flex">
              ...
              <nav className="flex">
                <div className="link-wrap">
                  <div className="active page-link" dest="home">
                    home
                  </div>
                  ...
                  {/* <div className="page-link" dest="blog">
                    blog
                  </div> */}
              ...
              <div className="skills-wrapper flex row-gt-sm">
                ...
                >
                  ...
                  <div>
                    ...
                    in India, IN.
                    <br />
                    I have serious passion for Coding, Design, Gaming and
          ...
          <footer>
            <i className="mdi mdi-chevron-double-up page-link" dest="home" />
